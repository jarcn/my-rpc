...
func (xc *XClient) call(rpcAddr string, ctx context.Context, serviceMehtod string, args, reply interface{}) error {
	client, err := xc.dial(rpcAddr)
	if err != nil {
		return err
	}
	return client.Call(ctx, serviceMehtod, args, reply)
}
